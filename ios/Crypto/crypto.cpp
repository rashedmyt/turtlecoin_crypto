...
namespace Crypto
{
    ...
    KeyImage scalarmultKey(const KeyImage &P, const KeyImage &a)
    {
        ge_p3 A;
        ge_p2 R;
    ...
    void hash_data_to_ec(const uint8_t *data, std::size_t len, PublicKey &key)
    {
        Hash h;
        ge_p2 point;
        ge_p1p1 point2;
    ...
    void generateViewFromSpend(const Crypto::SecretKey &spend, Crypto::SecretKey &viewSecret)
    {
